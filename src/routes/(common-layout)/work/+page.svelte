<script>
    import WorkTable from "../../../lib/view/work/workTable.svelte";
    import WorkTop from "../../../lib/view/work/workTop.svelte";
	import { Container, Row, Col, Card, CardHeader, CardBody,Button } from 'sveltestrap';
