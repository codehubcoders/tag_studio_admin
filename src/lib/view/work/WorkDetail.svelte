				...
				<Form>
					<Row class="mb-25 form-group">
						<Col sm={3} class="d-flex aling-items-center">
							<Label for="inputId" class=" col-form-label color-dark fs-14 fw-500 align-center"
								>작업명</Label
							>
						</Col>
						<Col sm={8}>
					...
					<Row class="mb-25 form-group">
						<Col sm={3} class="d-flex aling-items-center">
							<Label for="folder" class=" col-form-label color-dark fs-14 fw-500 align-center"
								>폴더링크</Label
							>
						</Col>
						<Col sm={9} class="d-flex aling-items-center">
							<Label for="folder" class=" col-form-label color-info fs-13 fw-500 align-center"
								><a href="">폴더 링크</a></Label
							>
                           <button
                            type="button"
                            class="border-0 px-15 mx-10 radius-xs bg-primary color-white fw-400 fs-13">링크</button
                        >
						</Col>
					</Row>
					<Row class="mb-25 form-group">
                    ...
                    <Row class="mb-25 form-group">
						<Col sm={3} class="d-flex aling-items-center">
							<Label for="endDate" class=" col-form-label color-dark fs-14 fw-500 align-center"
								>마감일</Label
							>
						</Col>
						<Col sm={9}>
                    ...
                    <Row class=" form-group">
						<Col sm={3} class="d-flex aling-items-center">
							<Label for="design" class=" col-form-label color-dark fs-14 fw-500 align-center"
								>시안</Label
							>
						</Col>
						<Col sm={9} class="d-flex aling-items-center">
...
<style lang="scss">
	...
	:global{
        ...
        .custom-date-ranger.custom-date-ranger__lg .datepicker .calendar-button, .custom-date-picker.custom-date-picker__lg .datepicker .calendar-button {
          padding: 10.5px 10px;
          border : 1px solid var(--border-light) !important;
          font-size: 13px;
          width: 40%;
